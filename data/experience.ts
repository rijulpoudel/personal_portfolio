...
export interface Experience {
  ...
  role: string;
  company: string;
  context?: string; // one-line description of the place
  location?: string;
  startDate: string;
  endDate?: string;
  description: string[];
  techStack?: string[];
  /** Dated notes appended over time, e.g. merged PRs. */
...
export const experiences: Experience[] = [
  {
    ...
    context:
      "KU Biodiversity Institute: open-source collections software used around the world.",
    location: "Lawrence, KS",
    startDate: "2026", // TODO(rijul): confirm exact start month
    description: [
      "Developing Specify 7, open-source software used around the world to manage natural history collections.",
